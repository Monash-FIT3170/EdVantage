...
const Login1 = () => {
    return (
        <section className="w-full text-black">
            <div className="bg-white relative flex flex-col justify-center items-center h-full">
                <div className="md:border md:border-gray-300 bg-white md:shadow-lg shadow-none rounded p-10" >
                    ...
                    <form className="my-8 text-left">
                        <div className="mb-2 flex flex-col gap-1">
                            <label htmlFor="email" className="label leading-tighter text-gray-600 text-base cursor-text">Email or phone</label>
                            <input id="email" className="w-full bg-white rounded px-3 border border-gray-300 pt-5 pb-2 focus:border-blue-700 focus:ring-1 focus:ring-blue-700 focus:outline-none input active:outline-none" type="text" autoFocus />
                        </div>
